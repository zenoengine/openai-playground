...
class DQNetwork:
    def __init__(self, state_size, action_size, learning_rate, name='DQNetwork'):
        ...
        with tf.variable_scope(name):
            ...
            self.actions_ = tf.placeholder(tf.float32, [None, env.action_space.n], name="actions_")
    ...
    with tf.Session() as sess:
        ...
        for episode in range(total_episodes):
            ...
            while step < max_steps:
                ...
                one_hot_action, explore_probability = predict_action(explore_start, explore_stop, decay_rate, decay_step, state, possible_actions)
